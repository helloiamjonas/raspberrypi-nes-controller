# Use a NES-controller with your Raspberry Pi (warning: the current implementation is stupid)
...
## Todo
- USE A NESCTRL OBJECT INSTEAD OF THE SHITTY GLOBAL VARS and be less stupid
